  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 md:py-8 max-w-5xl">
      ...
      <Tabs defaultValue="finder" className="w-full">
        <TabsList className="grid w-full grid-cols-3 mb-4 sm:mb-6 md:mb-8 gap-1 sm:gap-2 p-1 sm:p-2 bg-gray-100 rounded-lg">
          <TabsTrigger
            value="finder"
          ...
          <TabsTrigger
            value="quick"
            className="data-[state=active]:bg-teal-500 data-[state=active]:text-white hover:bg-teal-100 transition-colors border-2 border-teal-200 data-[state=active]:border-teal-500 rounded-md py-2 sm:py-3 font-medium shadow-sm flex flex-col items-center justify-center min-h-[3rem] sm:min-h-[4rem]"
          >
            <Search className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 mb-1" />
            <span className="text-xs sm:text-sm leading-tight">{t("Quick")}</span>
          </TabsTrigger>
          <TabsTrigger
            value="chart"
        ...
        <TabsContent value="quick" className="mt-0">
          <div className="bg-teal-50 p-3 rounded-lg mb-4 text-center">
            <h2 className="text-base sm:text-lg font-medium text-teal-800">{t("Quick Size Finder")}</h2>
          </div>
